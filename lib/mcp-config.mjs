...
// Everyday stdio/config surfaces only. `admin` is credential-authorized on HTTP and must never be
// written into generated `.mcp.json`: a stdio process with SYNAPSE_MCP_SURFACE=admin has no bearer
// and buildServer refuses to start. See [[decision-0015-admin-surface]].
