...
//   (start ids = an agent + any number of moc-<feature> targets, exactly like render.mjs)
//
...
// Forward ALL start ids to render — render.mjs accepts N start ids (agent + any number of moc-<feature>
