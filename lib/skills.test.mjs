...
import {
  ...
  sanitizeDescription, shippedSkill, GENERATED_MARKER, DEFAULT_MAX_DESCRIPTION, SHIPPED_SKILLS_DIR,
} from "./skills.mjs";
...
test("a skill THIS package hand-authored is installed verbatim, never generated over", () => {
  ...
  const { root, vaultDir, cleanup } = tmpVault({ "agent-oracle.md": agentMd({ id: "agent-oracle" }) });
  try {
