...
npm install @eborja/synapse@^0.2.0   # or: npm install ../path/to/synapse-framework
...
Alternate installs (dev / pin a git SHA): `npm install github:eborjaa/synapse#v0.2.0` or
